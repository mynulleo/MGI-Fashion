        ...
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
                <td class="body-content">
                    ...
                    <p class="p">
                        অভিনন্দন! আপনার রেসিডেন্স সফলভাবে <strong>BD Organization</strong> সিস্টেমে অনুমোদিত হয়েছে।
                        আমাদের
                        টিম আপনার জন্য সফটওয়্যার কনফিগারেশন সম্পন্ন করেছে।
                        নিচে আপনার লগইন তথ্য দেয়া হলো — অনুগ্রহ করে নিরাপদ স্থানে সংরক্ষণ করুন।
                    </p>

                    <div class="info-box" style="font-size:15px;">
                        <p style="margin:6px 0;">
                            <strong>🏢 বাসস্থান:</strong>
                            {{ $organization }}
                        </p>
                        <p style="margin:6px 0;">
                            <strong>🔗 লগইন লিংক:</strong>
                            <a href="{{ $url }}" style="color:#2c3d70; text-decoration:none;">
                                {{ $url }}
                            </a>
                        </p>
                        <p style="margin:6px 0;">
                            <strong>👤 ইউজারনেম:</strong>
                            <span
                                style="background:#fff; padding:2px 6px; border-radius:4px;">{{ $email }}</span>
                        </p>
                        <p style="margin:6px 0;"><strong>🔒 পাসওয়ার্ড:</strong> <span
                                style="background:#fff; padding:2px 6px; border-radius:4px;">{{ $password }}</span>
                        </p>
                        <p style="margin:6px 0;"><strong> ⏰ মেয়াদ শেষের তারিখ:</strong> <span
                                style="background:#fff; padding:2px 6px; border-radius:4px;">{{ $expired_date }}</span>
                        </p>
                    </div>

                    <p class="p">
                        প্রথমবার লগইন করার পরে অনুগ্রহ করে <strong>পাসওয়ার্ড পরিবর্তন</strong> করে নিন যাতে আপনার

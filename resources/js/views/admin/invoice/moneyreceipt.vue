    ...
    <view-page>
        <div class="receipt-container">
            <div class="receipt-content mx-auto">
                ...
                <!-- Payment Details -->
                <div v-if="data.payment_status == 'paid'">
                    <div class="receipt-body">
                        <div class="field-row">
                            <div class="label">Organization Name:</div>
                            <div class="value-container">
                                <span class="value-text text-success">{{ data.Organization?.owner_name }}</span>
                        ...
                        <div class="field-row">
                            ...
                            <div class="value-container">
                                <span class="value-text text-success">৳ {{ data.amount }}</span>
                                <div class="underline"></div>
                            </div>
                        </div>
                        <div class="field-row">
                        ...
                        <div class="field-row">
                            ...
                            <div class="value-container">
                                <span class="value-text">{{ data.card_type }}</span>
                                <div class="underline"></div>
                            </div>
                        </div>
                        <div class="field-row">
...
export default {
    ...
    methods: {
        getMultipleAccountHead: function (invoice_details) {
            if (!Array.isArray(invoice_details)) return '';

            return invoice_details.map(item => {
                const head = this.$root.global.account_heads.find(h => h.id === item.account_head_id);
                return head ? head.title : null;
            })
                .filter(Boolean)
                .join(', ');
        }

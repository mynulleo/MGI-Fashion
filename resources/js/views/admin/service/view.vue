  ...
  <view-page>
    <div class="view_page pb-4">
      <div class="row custom_row g-3">
        ...
        <div class="col-xl-6 col-lg-12">
          <fieldset>
            <span class="legend">Service Details</span>
      ...
      <div class="row custom_row g-3">
        <div class="col-xl-12 col-lg-12">
          <fieldset>
            ...
            <template
              v-if="
                (data.meta_tag && data.meta_tag.length) || data.meta_description
              "
            >
              <div
                class="col-lg-12 mt-2"
                v-if="data.meta_tag && data.meta_tag.length"
              >
                <button

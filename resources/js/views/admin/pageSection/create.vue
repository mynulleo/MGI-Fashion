<template>
    <create-form @onSubmit="submit">
        <template v-if="data.type == 'image'">
            <!-- <File title="Icon" field="data.icon" mime="img" col="3" fileClassName="data.icon" /> -->
            <File
                title="Image"
        ...
        <Fieldset class="mb-2">
            ...
            <template v-slot:content>
                <div class="row g-3">
                    ...
                    <div class="col-12 mb-3" v-if="data.type == 'text'">
                        <editor
                            title="Description"
...
export default {
    ...
    data() {
        return {
            page_title: "",
            model: model,
            data: { image: null, sorting: 0, status: "active" },
